...
class WC_Order_PDF_Download {
	...
	public function wcopd_check_some_other_plugin() {
		if ( ! class_exists( 'WooCommerce' ) ) {
			add_action( 'admin_notices', function() {				
				echo '<div class="error"><p><strong>' . esc_html__( 'Woocmmerce Addon Download plugin requires the WooCommerce plugin to be installed and activated!', 'wcorderpdf' ) . '</strong></p></div>';
			} );
			return;
		}
	}
	...
	public function wcopd_add_order_pdf_column_content( $column ) {
	    ...
	    if ( 'order_download' === $column ) {
	        ...
	        echo "<a class='order_download_pdf_col' href='".$pdf_url."'>".esc_html__( 'Download Invoice', 'wcorderpdf' )."</a>";        
	    }
	}
